...
public class NotificationService : INotificationService
{
    ...
    public async Task<BusinessResult> GenerateNotification(NotificationCreateCommand notification)
    {
        try
        {
            ...
            var foundUser = await _unitOfWork.UserRepository.GetById(notification.UserId);
    ...
    public async Task<BusinessResult> GetNotificationByUserId(Guid userId)
    {
        try
        {
            ...
            if (foundNotification == null) return new BusinessResult(Const.SUCCESS_CODE, Const.SUCCESS_READ_MSG, null);
