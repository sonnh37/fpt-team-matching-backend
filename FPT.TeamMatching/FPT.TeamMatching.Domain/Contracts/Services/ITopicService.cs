...
namespace FPT.TeamMatching.Domain.Contracts.Services
{
    public interface ITopicService: IBaseService
    {
        ...
        Task<BusinessResult> GetTopicInvitesForSubMentor(TopicGetListInviteForSubmentorQuery query);
        ...
        Task<BusinessResult> CreateDraft(TopicCreateDraftCommand command);
        Task<BusinessResult> UpdateDraft(TopicUpdateDraftCommand command);
